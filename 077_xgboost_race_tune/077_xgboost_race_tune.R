...
# ROC AUC (MATT'S 2 STAGE METHOD FROM 076): 0.839

# CONCLUSIONS: ----
# - RACING METHODS IMPROVE SPEED VS CONVENTIONAL GRID AS ONLY 12 COMBINATIONS WHERE TESTED VS 20
# - MATT'S METHOD OF TUNING LEARNING RATE FIRST AND THEN TUNING ADDITIONAL PARAMS HAD A HIGHER AUC 0.839 VS 0.831
